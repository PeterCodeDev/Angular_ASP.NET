...
@Component({
  ...
  standalone:true,
  imports: [RouterLink, MatButtonModule,CommonModule,MatTableModule,MatPaginatorModule,ListadoGenerico],
  templateUrl: './indice-cines.html',
  styleUrl: './indice-cines.css',
})
export class IndiceCines implements OnInit{
